...
export class CastDevice {
    constructor(service) {
        ...
        this.debug = rawDebug(`googlecast:device:${this.getFriendlyName().toLowerCase().replace(' ', '')}`);
    ...
    getFriendlyName() {
        ...
        if (this.service && this.service.txtRecord && this.service.txtRecord.fn) {
            name = this.service.txtRecord.fn;
        } else {
            name = 'Unknown device';
        }
